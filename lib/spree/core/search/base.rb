  ...
  module Core
    module Search
      class Base
        ...
        def retrieve_supplier_products supplier
          @products = supplier.products
          @products = get_base_scope_for_supplier_products(@products)
          curr_page = page || 1
        ...
        def get_base_scope_for_supplier_products products
          base_scope = products.spree_base_scopes.active
          base_scope = base_scope.in_taxon(taxon) unless taxon.blank?
          base_scope = get_products_conditions_for(base_scope, keywords)
          base_scope = add_search_scopes(base_scope)
          base_scope = add_eagerload_scopes(base_scope)
